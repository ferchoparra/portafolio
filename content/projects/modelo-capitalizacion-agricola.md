# Modelo de Capitalizacion de Renta Agropecuaria
...
| Dimension | Variable | Uso |
| --- | --- | --- |
| Productiva | Rendimiento | Estimacion base |
| Economica | Precios | Escenarios de renta |
| Territorial | Municipio | Comparacion espacial |
